...
$site_paypal = "https://paypal.me/callmehugo1"; // set site paypal donate link
$site_contact = "https://t.me/hugo_pmbot"; // set site contact us link
$daily_limit_user = "50"; // set daily limit


/* Server Data */
/* Format: Server_Name, IP_Address, Root_Pass, Account_Validity */
/* Example: 1=>array(1=>" Server 1","123.456.789","HUGO","5"), */

$server_lists_array=array(
			1=>array(1=>"HUGO SSH","xxxxxxxxx","saC090988lanun","3"),
	);			
