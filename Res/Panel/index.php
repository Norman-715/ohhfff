...
$site_name        = "HUGO SSH";
$site_description = "Provider of Premium Quality SSH, SSL,Websocket Accounts";
$site_template    = "flatly";
...
/* Example_1: 1=>array(1=>"Server 1","123.456.789","xdd","VIP"), */
/* Example_2: 2=>array(1=>"Server 2","123.456.789","xdd","Free"), */

$server_lists_array=array(
			1=>array(1=>"UNITED STATES","123.456.789","example","Free"),
			2=>array(1=>"SOUTH AFRICA","123.456.789","example","VIP"),
	);			
...
$host_websocket= 'us.hugossh.com';         // Websocket Ip
						...
						if ( !empty($invite_code))
							{
								if ( $invite_code != $invite_code_master )
									{
										$error = true;
										$inviteError = "Vip Code Is Incorrect";
									}
								else
									{
							...
							{
								$error = true;
								$inviteError = "Please Input Vip Code";
							}				
					}
...
<meta property="og:image" content="https://raw.githubusercontent.com/Norman-715/yes/main/logo.ico" />
...
<link rel="shortcut icon" type="image/x-icon" href="https://raw.githubusercontent.com/Norman-715/yes/main/logo.ico"> 
...
<img src="https://raw.githubusercontent.com/Norman-715/yes/main/logo.ico" width="30" height="30" class="d-inline-block align-top" alt="">
  <?php
echo $site_name;?>
</a>
...
<a class="nav-link" href="<?php echo $site_contact;?>"target="_blank">Contact Us <span class="sr-only">(current)</span></a>
	...
	<div align="center">
<img src="https://raw.githubusercontent.com/Norman-715/yes/main/cat.gif" alt="" height="200" width"200"/>
											...
											if($show == true) 
												{
													...
													echo '<tr>'; echo '<td>Squid Port</td>'; echo '<td>'; echo $port_squid; echo '</td>'; echo '</tr>';
                                                                                                        echo '<tr>'; echo '<td>WS DOMAIN</td>'; echo '<td>'; echo $host_websocket; echo '</td>'; echo '</tr>';
